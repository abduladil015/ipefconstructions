...
function ProjectView1() {
    ...
    <img class="bgi1" src="./images/Villa.jpg" alt=""></img>
    </div>
        </section>
  ...
  <div class="column">
    <img class="gallery" src="./images/Villa1.jpg" alt="Snow" ></img>
  </div>
  <div class="column">
    <img class="gallery" src="./images/Villa2.jpg" alt="Forest" ></img>
  </div>
  <div class="column">
    <img  class="gallery" src="./images/Villa3.jpg" alt="Mountains" ></img>
  </div>
</div>
		</section>
