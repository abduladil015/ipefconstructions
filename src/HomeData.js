...
function HomeData () {
  return (
    ...
    <section className="text-section">
      ...
      <a href="Projects"><img class="services" src="./images/structure.jpg" alt=""></img></a>
    	</div>
      <div>
      <h2 className="heading2">Architects Design</h2>
      <a href="Projects"><img class="services" src="./images/Architect.jpg" alt=""></img></a>
    	</div>
      <div>
      <h2 className="heading2">Interior Design</h2>
      <a href="Projects"><img class="services" src="./images/Interior.jpg" alt=""></img></a>
    	</div>
      </section>
