...
function HomeData () {
  return (
    ...
    <section className="text-section">
		<h1 className="heading">Welcome to IPEF Constructions</h1>
		<div className="description">
		<p><big>We are a group of young professionals, and building homes with great value for our clients is our inspiration. Striking balance between value and quality is an utmost priority to us. We are driven by a vision of creating sustainable communities for our clients in terms of living, spaces and amenities. Adhering to the highest quality and executing our projects with great precision and care is our job.<br/>
    </big></p>
    	</div>
	  </section>
      ...
      <a href="Projects"><img class="services" src="./images/Construction.jpg" alt=""></img></a>
    	</div>
      <div>
      <h2 className="heading2">Real Estate</h2>
      <a href="Projects"><img class="services" src="./images/Realestate.jpg" alt=""></img></a>
    	</div>
      </section>
